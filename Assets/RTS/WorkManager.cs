...
namespace RTS
{
	public static class WorkManager  
	{
		public static Rect CalculateSelectionBox(Bounds selectionBounds, Rect playingArea){
			...
			corners.Add (Camera.main.WorldToScreenPoint (new Vector3 (cx + ex, cy + ey, cz - ez)));
			corners.Add (Camera.main.WorldToScreenPoint (new Vector3 (cx + ex, cy - ey, cz + ex)));
			corners.Add (Camera.main.WorldToScreenPoint (new Vector3 (cx - ex, cy + ey, cz + ex)));
			corners.Add (Camera.main.WorldToScreenPoint (new Vector3 (cx + ex, cy - ey, cz - ex)));
			corners.Add (Camera.main.WorldToScreenPoint (new Vector3 (cx - ex, cy - ey, cz + ex)));
			corners.Add (Camera.main.WorldToScreenPoint (new Vector3 (cx - ex, cy + ey, cz - ex)));
			...
			//Screen coordinates start in bottom left corner, rather than the top left corner
			//this correction is needed to make sure the selection box i drawn in the correct place
